...
export default function MenuListClient({initiaMenus} : MenuListClientProps){
    // #1. 서버컴포넌트에서 전달받은 초기 데이터로 상태값 설정
    const [menus, setMenus] = useState<Menu[]>(initiaMenus);
    ...
    const handleDelete = async(id:number) => {
        ...
        // 추가적으로 케시데이터를 삭제하는 코드가 있으면 추가(근디 지금은 없음)
    }
