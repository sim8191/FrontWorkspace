...
class Hamster extends Pet{
    ...
    info(){
        console.log("이 햄스터는 "+ this.kind + " 햄스터 종이며, 이름은 "+this.name+"입니다.");
        // if(this.food != null){
...
type ProductUpdateInput = 
Pick<Product, "id"|"name"|"price"> & Partial<Pick<Product, "description"|"stock">>;
...
// <pre class="language-typescript"><code class="lang-typescript">type PostData = {
//   id: number;
//   title: string;
//   content: string;
//   comments: string[];
