...
export default function ArrayBinding(){
    const[fruits, setFruits] = useState([{id:1,name:"apple"},{id:2,name:"banana"},{id:3,name:"토마토"}]);
                ...
                {   
                    ...
                    */
                    fruits.map((fruit) => (
                        ...
                        */
                        <li key={fruit.id}>{fruit.id} - {fruit.name}</li> //key={fruit.id} 이거 안쓰면 경고함(이거 랜더링하는데 힘들다고)
                    ))
                }
            </ul>
